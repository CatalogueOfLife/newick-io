...
public class NHXNode extends XNode<NHXNode> {
  ...
  /**
   * protein-length>from>to>support>name>from>...	int int int double string int ...	domain structure at this node	<domain_architecture>(<sequence>)
   */
